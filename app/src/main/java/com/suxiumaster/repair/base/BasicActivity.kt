...
import com.suxiumaster.repair.databinding.ActBasicBinding
...
open class BasicActivity : AppCompatActivity() {
    ...
    private var mFragments = HashMap<String , BasicFragment<out ViewDataBinding>>()
    ...
    fun startFragment(@IdRes fragmentViewId: Int, cls: Class<out BasicFragment<out ViewDataBinding>>, tag: String) {
    ...
    fun startFragment(@IdRes fragmentViewId: Int, fragment: BasicFragment<out ViewDataBinding>, @NotNull tag: String) {
        if (fragment != null) {
